    ...
    private Entry readEntry(XmlPullParser parser) throws XmlPullParserException, IOException {
        ...
        Log.d("readEntry","START");
            ...
            for (int i = 0; i < parser.getAttributeCount(); i++) {
            	...
            	//<radek kod="ISK" mena="koruna" mnozstvi="100" kurz="18,360" zeme="Island"/>
            	if (parser.getAttributeName(i).equals("mena")) {
                    mena = parser.getAttributeValue(i);
                } else if (parser.getAttributeName(i).equals("kod")) {
        ...
        parser.next();
        cena = Double.valueOf(kurz) / Double.valueOf(mnozstvi);
        return new Entry( mena, kod, stat, cena);
    }
